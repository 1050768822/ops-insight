...
- `../coordination/docs/clean-architecture.md` — 架构层级与依赖规则
- `../coordination/docs/rust-guidelines.md` — Rust 编码规范
- `../coordination/docs/security.md` — API Key 安全规则
- `../coordination/docs/log-formats.md` — 日志格式与解析规则
